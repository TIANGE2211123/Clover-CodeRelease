...
void batched_l2_distance_gemm(cublasHandle_t handle,
    ...
    // Temporary storage for squared norms
    ...
    compute_squared_norms_fp16<<<grid_size_A, block_size>>>(A, norms_A, M, D);
    compute_squared_norms_fp16<<<grid_size_B, block_size>>>(B, norms_B, N, D);
